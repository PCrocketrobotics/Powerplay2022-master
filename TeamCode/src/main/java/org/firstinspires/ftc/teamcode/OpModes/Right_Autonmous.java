...
import org.firstinspires.ftc.teamcode.Robot.AprilTag_powerPLAY;
import org.firstinspires.ftc.teamcode.Robot.Robot;


@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name="right", group="Production")

public class Right_Autonmous extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        if (opModeIsActive()) {
            while (opModeIsActive()) {
                ...
                robot.getMecanumDriveTrain().gyroTurn(.4,45);
                sleep(500);
                // turns robot to an angle of 30
                robot.getMecanumDriveTrain().gyroDrive(13.3,13.3,13.3,13.3,.4,45);
                sleep((100));
                // moves forward 10in
                ...
                robot.getMecanumDriveTrain().gyroDrive(-25,-25,-25,-25,.4,45);
                sleep(500);
                ...
                if (AprlTagFound==(1)){
                    ...
                    robot.getMecanumDriveTrain().gyroDrive(45,45,45,45,.4,0);
                    sleep(100);
                    //moves 32in forward;
                }
                if(AprlTagFound==(2)) {
